            ...
            {tasks.map(task =>
                <div
                    ...
                    <div className="flex flex-col items-center pb-10">
                        <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">Completed</h5>
                        <span className="text-sm text-gray-500 dark:text-gray-400">DOMINATED</span>
                        <div className="flex mt-4 md:mt-6">
                            <a href="#"
                               ...
                               focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add
                                friend</a>
                            <a href="#"
                               ...
                               dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Message</a>
                        </div>
                    </div>
                </div>
            )}
